...
# Import our modules
from .pattern_recognition_module import PatternRecognitionModule, Pattern
from .cloth_recognition_module import ClothRecognitionModule, ClothMaterial
from .pattern_fitting_module import PatternFittingModule
from .config import SYSTEM, TRAINING, VISUALIZATION
...
class CuttingEdgeSystem:
    ...
    def __init__(self, base_dir: str = None):
        ...
        logger.info(f"Cutting Edge System initialized")
